...
/* 2M 15fps */
#define WIDTH_15FPS_PREV       1536
#define HEIGHT_15FPS_PREV      1152
#define XOFF_15FPS_PREV       48
#define YOFF_15FPS_PREV       36
...
/* 8M */
#define WIDTH_SNAP     3232//3264
#define HEIGHT_SNAP    2424//2448
#define XOFF_SNAP      16
#define YOFF_SNAP     	12
...
/* ae. */
/* VGA 30FPS */
#define AE_30FPS_30_MAX_IDX  110
#define AE_30FPS_30_MIN_IDX  5 // 0
#define AE_30FPS_25_MAX_IDX  110
#define AE_30FPS_25_MIN_IDX  5 // 0
#define EV10_30FPS_EXP_IDX   100

/* 2M 15FPS */
#define AE_15FPS_30_MAX_IDX  120 // 133
#define AE_15FPS_30_MIN_IDX  5 // 0
#define AE_15FPS_25_MAX_IDX  120 // 131
#define AE_15FPS_25_MIN_IDX  5 // 0
 ...
 **************************************************************************/
/* ae table. */
static code frontAe_t ae30fps50hzTbl[122] = {
	{	0,	332,	107,	0,	0 },
	{	1,	332,	99,	0,	0 },
	{	2,	332,	91,	0,	0 },
	{	3,	332,	84,	0,	0 },
...
static code frontAe_t ae30fps60hzTbl[124] = {
	{	0,	299,	111,	0,	0 },
	{	1,	299,	103,	0,	0 },
	{	2,	299,	95,	0,	0 },
	{	3,	299,	87,	0,	0 },
...
)
{
	...
	if(sensor_switch){
		...
		gpioByteFuncSet(GPIO_BYTE_GEN0, (1 << ( 1 & 0x07)), (1 << ( 1 & 0x07)));  //gpio 1 reset 大镜头
