...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\STRING.H" /0
...
#line 13 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\STRING.H" /1
  
 
 
#line 16 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\STRING.H" /0
 
 
#line 18 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\STRING.H" /1
  
 
#line 20 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\STRING.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\STDLIB.H" /0
...
#line 13 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\STDLIB.H" /1
  
 
 
#line 16 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\STDLIB.H" /0
 
 
#line 18 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\STDLIB.H" /1
  
 
#line 20 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\STDLIB.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\COMMON.H" /0
...
#line 32 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\COMMON.H" /1
  
 
#line 34 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\COMMON.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\FRONT_PARA.H" /0
...
#line 35 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\FRONT_PARA.H" /0
#line 35 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\FRONT_PARA.H" /0
...
#line 61 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\FRONT_PARA.H" /1
 
 
#line 63 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\FRONT_PARA.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\SYS_MEM_INIT.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\ICAT_STUB.H" /0
...
#line 41 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\ICAT_STUB.H" /1
...
#line 236 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\ICAT_STUB.H" /0
 
 
 
 
#line 36 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\SYS_MEM_INIT.H" /0
 
  
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\LSC_CAL.H" /0
...
#line 143 "..\..\..\HOST\INC\CUSTOMIZATION\HOST_FUNC_OPT.H" /1
  
 
#line 145 "..\..\..\HOST\INC\CUSTOMIZATION\HOST_FUNC_OPT.H" /0
...
#line 33 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\LSC_CAL.H" /0
...
#line 111 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\LSC_CAL.H" /1
 
 
 
#line 114 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\LSC_CAL.H" /0
...
#line 37 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\SYS_MEM_INIT.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\KNL_FUNC_OPT.H" /0
...
#line 31 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\KNL_FUNC_OPT.H" /1
...
#line 188 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\KNL_FUNC_OPT.H" /0
...
#line 38 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\SYS_MEM_INIT.H" /0
 
  
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\MOTION_DET.H" /0
...
#line 31 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\MOTION_DET.H" /0
...
#line 32 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\MOTION_DET.H" /0
...
#line 38 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\MOTION_DET.H" /1
  
 
#line 40 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\MOTION_DET.H" /0
...
#line 39 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\SYS_MEM_INIT.H" /0
...
#line 65 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\SYS_MEM_INIT.H" /1
...
#line 71 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\SYS_MEM_INIT.H" /0
...
#line 114 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\SYS_MEM_INIT.H" /1
 
 
 
 
#line 118 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\SYS_MEM_INIT.H" /0
 MEM_IDX_USB,
...
#line 181 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\SYS_MEM_INIT.H" /1
...
#line 196 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\SYS_MEM_INIT.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\HOST\INC\CUSTOMIZATION\SOLUTION.H" /0
...
#line 69 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\HOST\INC\CUSTOMIZATION\SOLUTION.H" /1
  
 
#line 71 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\HOST\INC\CUSTOMIZATION\SOLUTION.H" /0
 
 
#line 73 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\HOST\INC\CUSTOMIZATION\SOLUTION.H" /1
  
 
#line 75 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\HOST\INC\CUSTOMIZATION\SOLUTION.H" /0
 
 
#line 77 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\HOST\INC\CUSTOMIZATION\SOLUTION.H" /1
  
 
#line 79 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\HOST\INC\CUSTOMIZATION\SOLUTION.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\FUNC_TIMER_DEF.H" /0
...
#line 41 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\FUNC_TIMER_DEF.H" /1
  
 
#line 43 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\FUNC_TIMER_DEF.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\SP1K\SP1K_DEF.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\HAL\HAL_DEVICE.H" /0
...
#line 28 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\HAL\HAL_DEVICE.H" /0
...
#line 46 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\HAL\HAL_DEVICE.H" /1
...
#line 56 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\HAL\HAL_DEVICE.H" /0
...
#line 151 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\HAL\HAL_DEVICE.H" /0
...
#line 153 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\HAL\HAL_DEVICE.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\HAL\HAL_GPIO.H" /0
...
#line 30 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\HAL\HAL_GPIO.H" /1
...
#line 96 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\HAL\HAL_GPIO.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\SP1K\SP1K_AE_API.H" /0
...
#line 23 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\SP1K\SP1K_AE_API.H" /1
...
#line 420 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\SP1K\SP1K_AE_API.H" /0
...
#line 23 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\SP1K\SP1K_DEF.H" /1
...
#line 29 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\SP1K\SP1K_DEF.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_DEF.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_DRAM.H" /0
...
#line 36 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_DEF.H" /0
 
  
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_CDSP.H" /0
...
#line 37 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_DEF.H" /0
 
  
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_CPU.H" /0
...
#line 38 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_DEF.H" /0
 
  
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_DISP.H" /0
...
#line 39 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_DEF.H" /0
 
  
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_FRONT.H" /0
...
#line 40 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_DEF.H" /0
 
  
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_MOE.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\GENERAL.H" /0
...
#line 24 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\GENERAL.H" /1
...
#line 36 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_MOE.H" /0
#line 36 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_MOE.H" /0
...
#line 41 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_DEF.H" /0
 
  
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_GPRM.H" /0
...
#line 42 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_DEF.H" /0
 
  
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_DMA.H" /0
...
#line 43 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_DEF.H" /0
 
  
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_II.H" /0
...
#line 36 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_II.H" /0
#line 36 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_II.H" /0
...
#line 44 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_DEF.H" /0
 
  
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_FD.H" /0
...
#line 36 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_FD.H" /0
#line 36 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_FD.H" /0
...
#line 45 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_DEF.H" /0
 
  
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_JPEG.H" /0
...
#line 46 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_DEF.H" /0
 
  
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_FM.H" /0
...
#line 47 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_DEF.H" /0
 
  
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_AUDIO.H" /0
...
#line 48 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_DEF.H" /0
 
  
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_USB.H" /0
...
#line 49 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\REG_DEF.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\OSD_COM.H" /0
...
#line 36 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\MIDDLEWARE\OSD_COM.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\DIST_FUNC.H" /0
...
#line 33 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\DIST_FUNC.H" /1
  
 
#line 35 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\DIST_FUNC.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\DBG_FILE_LIST.H" /0
...
#line 32 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\DBG_FILE_LIST.H" /1
...
#line 232 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\DBG_FILE_LIST.H" /0
 
#line 29 "..\..\..\KERNEL\INC\DBG_DEF.H" /0
 
  
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\DBG_ASSERT.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\DBG_STR.H" /0
...
#line 1 "\CODE\1627\M03\测试写日戳画点(有用)\CDAF\KERNEL\INC\DBG_WDT.H" /0
