...
static keyMsg_t code keyMsg[SP1K_BTN_NUM] = {
	...
	/*ADC B button msg*/
	{SP1K_MSG_KEY_PRESS_MENU,			SP1K_MSG_KEY_REPEATE_MENU,			SP1K_MSG_KEY_RELEASE_MENU},//set
	//{SP1K_MSG_KEY_PRESS_BURST, 		SP1K_MSG_KEY_REPEATE_BURST,			SP1K_MSG_KEY_RELEASE_BURST},
	{SP1K_MSG_KEY_PRESS_UP, 			SP1K_MSG_KEY_REPEATE_UP,			SP1K_MSG_KEY_RELEASE_UP},//up
	{SP1K_MSG_KEY_PRESS_BACK, 			SP1K_MSG_KEY_REPEATE_BACK,			SP1K_MSG_KEY_RELEASE_BACK},//back
	{SP1K_MSG_KEY_PRESS_PB, 			SP1K_MSG_KEY_REPEATE_PB,			SP1K_MSG_KEY_RELEASE_PB},//play
	{SP1K_MSG_KEY_PRESS_DOWN, 			SP1K_MSG_KEY_REPEATE_DOWN,			SP1K_MSG_KEY_RELEASE_DOWN},//down
	{SP1K_MSG_KEY_PRESS_OK, 			SP1K_MSG_NULL,						SP1K_MSG_KEY_RELEASE_OK},//ok
	{SP1K_MSG_KEY_PRESS_MODE,			SP1K_MSG_NULL,						SP1K_MSG_KEY_RELEASE_MODE},//a/b
...
static void keyScanGpioParsing(keyUnitGpio_t* pGpio)
{
	...
	if (*pGpio->keyAttr[gpioChn].pKeyEn) {
		...
		gpioChn = 3;	// snap gpio2

		if (*pGpio->keyAttr[gpioChn].pKeyEn) {
			sp1kPullEnSet(4, 0x08, 0x08);
			sp1kPullSelSet(2, 0x80, 0x80);
			HAL_GpioByteDirSet_Intr(HAL_GPIO_BYTE_GEN0, 0x04, 0x00);  // set gpio[9] as input.
			gpioVal = HAL_GpioByteInGet(HAL_GPIO_BYTE_GEN0, 0x04, 1);
